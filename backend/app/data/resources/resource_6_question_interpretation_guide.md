...
- **Q123 (Safety/emergency responsibility — track record):** Evidence companion to Q032. Where Q032 asks how skilled they feel, Q123 asks how much real responsibility they actually carried. A high Q123 corroborates safety/HSE (P6), healthcare (P11), and ground-aviation (P10) fit even when the self-rated Q032 reads modestly — crew systematically undervalue this. Treat a high Q123 with a low Q032 as a confidence signal, not a contradiction.
- **Q124 (Developing others — track record):** Evidence companion to Q034. Q124 captures whether they have formally trained, mentored, or signed others off, not just their self-rated instructing skill. High Q124 strengthens P1, P2, P14. If Q124 is high but Q034 is modest, lean toward the demonstrated track record.
- **Q125 (Leadership span — track record):** The only question that measures leadership *actually held* (Q019 measures enjoyment, Q054 measures aspiration). High Q125 is the strongest in-module signal for management-track fit (P3, P5, P7, P2, P14). Do not confuse a low Q125 with low potential — many capable crew have had few formal lead opportunities; weight aspiration (Q054) alongside it.
